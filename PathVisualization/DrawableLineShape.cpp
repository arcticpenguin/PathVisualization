...
//See Drawable::Render
void DrawableLineShape::draw(sf::RenderTarget &target, sf::RenderStates rs) const
{
	...
	//set line thickness
	glLineWidth(40);//m_fLineThickness
	...
	{
		glVertex2f(m_vPoints[i].v2fPoint.x, m_vPoints[i].v2fPoint.y);
	}
